...
public abstract class YandexTranslatorAPI {
     ...
     */
    public static String retrieveResponse(final URL url) throws Exception {
     ...
     */
    public static String retrievePropString(final URL url, final String jsonValProperty) throws Exception {
     ...
     */
    public static String retrievePropArrString(final URL url, final String jsonValProperty) throws Exception {
        final String response = new RetrieveResponse().execute(url).get();
    ...
    public static String[] jsonObjValToStringArr(final String inputString, final String subObjPropertyName) throws Exception {
    ...
    public static String[] jsonArrToStringArr(final String inputString, final String propertyName) throws Exception {
